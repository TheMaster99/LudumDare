...
public class Asteroid {
    ...
    public void destroy() {
        ...
        shards[0] = new Shard(sheet, asteroidType, Float.parseFloat(Double.toString(xPos)), Float.parseFloat(Double.toString(yPos)));
        shards[1] = new Shard(sheet, asteroidType, Float.parseFloat(Double.toString(xPos)), Float.parseFloat(Double.toString(yPos)));
        shards[2] = new Shard(sheet, asteroidType, Float.parseFloat(Double.toString(xPos)), Float.parseFloat(Double.toString(yPos)));

        shards[0].speedY -= 0.75f;
        shards[2].speedY += 0.25f;

        isDestroyed = true;
        System.out.println(shards[0] != null);
    }
